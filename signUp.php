...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $phone = trim($_POST['phone']); // New phone number field
    ...
    if ($role === "user") {
        ...
        $stmt = $conn->prepare("INSERT INTO drivers (full_name, email, phone, password, license_number, vehicle_number) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssss", $full_name, $email, $phone, $password, $license_number, $car_number);
    } else {
